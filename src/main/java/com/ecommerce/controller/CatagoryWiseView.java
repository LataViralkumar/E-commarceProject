...
public class CatagoryWiseView {
	...
	@GetMapping("userpage/Catagory")
	public ModelAndView  CatogryWiseDisplay(@RequestParam("Catagory") String Catagory ) {
		...
		pt = (ArrayList<ProductTable>)this.homepageProductView.getItemByCatagory(Catagory);
