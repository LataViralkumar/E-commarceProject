...
const item_incriment = (quntity,productp,itemprice ,iprice,mtotal,atotal , finalprice)=>{
...
const item_decriment= (quntity,productp,itemprice,iprice,mtotal,atotal,finalprice)=>{
